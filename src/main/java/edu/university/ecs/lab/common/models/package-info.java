 ...
 *   - {@link edu.university.ecs.lab.common.models.ir.AbstractClass} Represents a Java class whether it's an actual class or interface, enum, or record.
 ...
 *   - {@link edu.university.ecs.lab.common.models.ir.Component} Represents any part of a class (such as a Method or Field).
 *   - {@link edu.university.ecs.lab.common.models.ir.ConfigFile} Represents a configuration file (such as a pom.xml).
 ...
 *   - {@link edu.university.ecs.lab.common.models.ir.Location}: Represents a line number range in which a Component can be found in a file.
 ...
 *   - {@link edu.university.ecs.lab.common.models.ir.ProjectFile}: Represents a file in the project such as an AbstractClass or ConfigFile.
