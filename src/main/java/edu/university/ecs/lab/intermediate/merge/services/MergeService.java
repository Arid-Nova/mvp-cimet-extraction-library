...
//import edu.university.ecs.lab.delta.models.AbstractDelta;
...
//     */
//    public void addFile(AbstractDelta delta) {
//        // Check for unparsable files
////        if(delta.getClassChange() == null && delta.getConfigChange() == null)
////            return;
//
//        Microservice ms = microserviceSystem.findMicroserviceByPath(delta.getPath().toString());
//
...
//     * @param delta the delta change for removal
//     */
//    public void updateComponents(AbstractDelta delta) {
//        Microservice ms = microserviceSystem.findMicroserviceByPath(delta.getOldPath());
//
//        // If we are updating a file and it's microservice doesn't exist
//        if (Objects.isNull(ms)) {
//            // Check the orphan pool
//            for (ProjectFile orphan : microserviceSystem.getOrphans()) {
//                // If found remove it and return
...
//    }
//
////    private void updateClass(JClass jClass, List<Component> components) {
////        for(Component component1 : jClass.getComponents()) {
////            for(Component component2 : components) {
////                if(component1.getName().equals(component2.getID())) {
////
////                }
////            }
////        }
...
//                        }
//
//                        microservice = new Microservice(microserviceSystem, tokens[tokens.length - 2], delta.getNewPath().replace("/pom.xml", "").replace("/build.gradle", ""));
...
//        List<AbstractDelta> addDeltas = filteredDeltas.stream().filter(d -> d.getChangeType().equals(ChangeType.ADD)).collect(Collectors.toList());
